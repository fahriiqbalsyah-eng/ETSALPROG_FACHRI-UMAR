...
Pastikan Anda sudah menginstal [Rust](https://www.rust-lang.org/tools/install) di komputer Anda. Buka terminal, masuk ke folder repositori ini, lalu jalankan perintah:
```bash
cargo run
